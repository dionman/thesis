	...
	\begin{block}{Graph Kernels} Express similarity as inner product of vectors with graph statistics \textcolor{black}{\Fontit{\citep{Vishwanathan2010}}}
		\begin{itemize}
			...
			\item  $\blacktriangleright$ \textbf{Deep Kernels}: \Fontit{\citep{yanardagV15}} \\
			 additionally learn an encoding of similarities between substructures
		\end{itemize}
	\end{block}	
\end{frame}
...
\begin{frame}
	...
	\begin{tcolorbox}[colback=green!5,colframe=white!40!black,title=KL Lower Bound in Gaussian mean inference via coresets]  

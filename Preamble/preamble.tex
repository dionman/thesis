...
%%  Adapted by Dionysis Manousakas for personal use.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{tikz}
\usepackage{xifthen}
...
%\usepackage[backref=page]{hyperref} %typical linking package
...
\renewcommand\nomgroup[1]{%
	\item[\bfseries
	\ifstrequal{#1}{A}{General Abbreviations}{%
		\ifstrequal{#1}{F}{$f$-divergence Abbreviations}{%
			\ifstrequal{#1}{M}{Mathematical Notation}{}}}%
	]}
...
\newcommand{\giga}{{\fontfamily{cmtt}\selectfont{GIGA}}}
\newcommand{\gigao}{{\fontfamily{cmtt}\selectfont{GIGA~(Optimal)}}}
\newcommand{\gigar}{{\fontfamily{cmtt}\selectfont{GIGA~(Realistic)}}}
\newcommand{\optimal}{{\fontfamily{cmtt}\selectfont{Optimal}}}
\newcommand{\realistic}{{\fontfamily{cmtt}\selectfont{Realistic}}}
\newcommand{\uniform}{{\fontfamily{cmtt}\selectfont{Uniform}}}
\newcommand{\dpsvi}{{\fontfamily{cmtt}\selectfont{DP-PSVI}}}
\newcommand{\dpvi}{{\fontfamily{cmtt}\selectfont{DP-VI}}}
...
\newcommand{\bcores}{\mbox{$\beta$-Cores}}
...
\newcommand{\psvi}{PSVI}
\newcommand{\sparsevi}{SparseVI}
\newcommand{\randomcoreset}{RANDOM}
...
\RequirePackage[backend=biber, style=numeric, sorting=nty, natbib=true, maxbibnames=99, uniquelist=false, uniquename=false, backref=true]{biblatex}

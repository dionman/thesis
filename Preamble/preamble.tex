...
\RequirePackage[backend=biber, style=authoryear-comp, citestyle=authoryear-comp, sorting=ynt, natbib=true, maxbibnames=99,maxcitenames=2, uniquelist=false, uniquename=false,backref=true,dashed=false]{biblatex}

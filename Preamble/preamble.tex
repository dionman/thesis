...
\RequirePackage[backend=biber,  citestyle=numeric, style=numeric, sorting=nty, natbib=true, maxbibnames=99,maxcitenames=2, uniquelist=false, uniquename=false]{biblatex}

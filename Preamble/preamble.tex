...
\newcommand{\betadistance}[3][]{\distance[#1]{\beta}{#2}{#3}}
...
\RequirePackage[backend=biber, style=numeric,citestyle=numeric, sorting=nty, natbib=true, maxbibnames=99,maxcitenames=2, uniquelist=false, uniquename=false,backref=true]{biblatex}

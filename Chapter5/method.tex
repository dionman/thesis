...
Hence, considering that the weight of the non-zero support for the updated coreset will be optimized in the subsequent step~\cref{eq:opt2} of the algorithm, and using the information-geometric argument presented in~\textcitec{campbell19neurips}, we finally rely instead on the following correlation maximization criterion:
\[

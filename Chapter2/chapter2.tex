...
\begin{figure*}[!t]
	...
	\end{subfigure}	
	\caption{Effects of changing statistical divergence when conducting inference on datasets containing outliers. (\subref{fig:influence})~The influence of individual datapoints under the Kullback-Leibler and the $\beta$-divergence: the concavity of influence under the $\beta$-divergence illustrates the robustness of the inferred posterior to outliers.}

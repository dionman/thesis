...
\begin{table}[!t]
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\caption{Reductions of relative entropy and density power to Bregman divergences on the domain of probability density functions.}

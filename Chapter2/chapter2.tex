...
Throughout the thesis we focus primarily on probability spaces equipped with measures that are absolutely continuous~\wrt~some base measure, corresponding to the Lebesgue and counting measure on continuous and discrete sets respectively. This allows us to simplify notation and adapt the definitions presented in this section to normalised probability densities.

...
The fundamental idea underpinning all variational inference~(VI) methods~\citep{wainwright08,blei17} is to reduce Bayesian posterior inference into an optimization problem; hence, ideas allowing scaling up optimization can in principle be applied in VI, enabling scalable inference of approximate posteriors.

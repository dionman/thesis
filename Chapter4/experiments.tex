...
\begin{figure*}[!t]
  ...
  \end{subfigure}
	\caption{Comparison of coreset approximate posterior quality for experiments on synthetic datasets over {10 trials}. %\cref{fig:gauss_mean_200,fig:gauss_mean_500}: Gaussian mean inference experiments on $10^3$~datapoints.  \cref{fig:gauss_cov_100}: Bayesian linear regression on $2\times10^3$~datapoints.  
		Solid lines

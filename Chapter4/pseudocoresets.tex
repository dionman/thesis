...
intractable normalization constants and expectations, we show in Appendix~\ref{app:gradient_derivations}
...
(e.g.~the synthetic experiment in \cref{section:gaussian_experiment}; see also Appendix~\ref{app:gaussian_experiment_appendix}),

...
\nomenclature[A]{NUTS}{No U-Turn Sampling}
...
\nomenclature[A]{\psvi}{Pseudocoresets Sparse VI}
%\nomenclature[A]{\sparsevi}{Sparse VI}
\nomenclature[A]{\randomcoreset}{Random Sampling Coreset}
...
\nomenclature[C]{$O$}{asymptotic upper bound}


% Others
\nomenclature[D]{$\mcX^N$ / $(\mcX \times \mcY)^N$}{Data space of $N$ unlabeled/labeled observations}
...
\nomenclature[D]{$\plaindb$}{$\beta$-divergence}
\nomenclature[D]{$\operatorname{Var}$}{Variance}
\nomenclature[D]{$\operatorname{Cov}$}{Covariance}
\nomenclature[D]{$\operatorname{Corr}$}{Correlation}
...
% Operators
\nomenclature[H]{$\operatorname{diag}$}{Matrix diagonal opertator}
\nomenclature[H]{$\operatorname{tr}$}{Matrix trace operator}
\nomenclature[H]{$\mathbb{P}$}{Probability operator}
\nomenclature[H]{$\mathbb{E}$}{Expectation operator}

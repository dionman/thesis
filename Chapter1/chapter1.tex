...
\emph{Automated methods for probabilistic learning are typically computationally prohibitive in settings involving massive-scale data. In contrast, designing principled data summarization algorithms enables scaling up learning methods, achieving realiable inference results and addressing concerns of privacy and robustness. Notably, the latter can be achieved without substantial impact on automation and complexity of the summarization methods.}
